package test.debug.app;

import java.util.Collections;
import java.util.Comparator;
import java.util.List;

import test.debug.organization.Organization;
import test.debug.organization.OrganizationMgr;
import test.debug.organization.OrganizationMgrImpl;
import test.debug.person.PersonMgr;
import test.debug.person.PersonMgrImpl;
import test.debug.subject.Algo;
import test.debug.subject.DuplicatedException;
import test.debug.subject.NotFoundException;
import test.debug.subject.Subject;
import test.debug.subject.SubjectsMgr;
import test.debug.subject.SubjectsMgrImpl;
import test.debug.subject.Web;
...
public class MainTest {
  ...
  //<- 주석 해제 후 작성 : start ////////////////////////////////
		...
		// JAVA: 등록된 과목입니다.
		try {
			subMgr.add(new Algo("알고리즘", 8, "IM"));
			subMgr.add(new Web("JAVA", 15, 20)); 
			subMgr.add(new Web("JAVA", 26, 18));
...
*/ //<- 주석 해제 후 작성 : end /////////////////////////////////
 ...
 //<- 주석 해제 후 작성 : start ////////////////////////////////
		...
		// 구미	120	301	10	2
		Organization org=omgr.search("구미"); 
		System.out.println(org);
		System.out.println();
 //<- 주석 해제 후 작성 : end /////////////////////////////////
